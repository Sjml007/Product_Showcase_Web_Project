      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="flex gap-6">
            <motion.a href="#" whileHover={{ color: "#7CFF4F" }} className="hover:text-white transition-colors">Privacy Policy</motion.a>
            <motion.a href="#" whileHover={{ color: "#7CFF4F" }} className="hover:text-white transition-colors">Terms of Service</motion.a>
          </div>
        </motion.div>
      </div>
    </footer>
